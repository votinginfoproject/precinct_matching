...
from townconf import Headers, HashFields, Conversions, Prefixes, Files
...
def main():
	...
	if loc_data['state'] not in LOC_TOWN:
		sys.exit('Localities for this state are not town based')
	if args.county:
